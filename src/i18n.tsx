...
export const ar: Dict = {
  ...
  schedule: {
    ...
    note: "يُفتح هذا المواعيد عند اكتمال عدد كافٍ من المشتركات.",
    tracks: [
      { title: "مواعيد أوروبا والشرق الأوسط والخليج", days: "الإثنين والأربعاء", time: "١٠:٠٠ صباحاً بتوقيت إسطنبول" },
      { title: "مواعيد الساحل الشرقي لأمريكا الشمالية", days: "الثلاثاء والخميس", time: "٩:٠٠ صباحاً (EST)" },
      { title: "مواعيد الساحل الغربي لأمريكا الشمالية", days: "الإثنين والجمعة", time: "٩:٠٠ صباحاً (PST)" },
    ],
  },
  privacy: {
...
export const testimonialsEn: Testimonial[] = [
  ...
  { name: "Tayyiba Nour", badge: "Simple, Manageable, and Sustainable",
...
export const testimonialsAr: Testimonial[] = [
  ...
  { name: "طيبة نور", badge: "بسيط وسهل ألتزم فيه",
  ...
  { name: "مينا أحمد", badge: "الدعم الذي كنت أفتقده",
