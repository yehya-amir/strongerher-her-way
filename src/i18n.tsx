...
export const en = {
  ...
  hero: {
    eyebrow: "Fitness · Nutrition · Lifestyle Coaching for Women",
    ...
    p2: "Without extreme diets, random workouts, or figuring it out alone. Finally get consistent with a coach and a community of sisters supporting you every step of the way.",
    cta: "Join the 6-Week Bootcamp",
    starts: "StrongerHer Summer Bootcamp · Starts June 21, 2026",
    badgeTop: "Live coached",
    badgeBottom: "Women-only · Private · Recorded",
  },
  video: {
    eyebrow: "Watch & Learn",
    h2: "Watch How the StrongerHer Summer Bootcamp Works",
    p: "In this short video, Coach Hebah explains how the 6-week bootcamp helps women lose fat, build strength, understand nutrition, and stay consistent with the support of live coaching and a women-only community.",
    soon: "Sales video coming soon",
    soonSub: "Coach Hebah explains the bootcamp here",
  },
  stories: {
    eyebrow: "Success Stories",
    h2: "Real women. Real progress.",
    p: "See what women have experienced through Coach Hebah's coaching, nutrition guidance, accountability, and supportive community.",
  },
  results: {
    eyebrow: "Outcomes",
...
export const ar: Dict = {
  ...
  hero: {
    eyebrow: "تدريب اللياقة · التغذية · نمط الحياة للنساء",
    ...
    p2: "بدون حميات قاسية، أو تمارين عشوائية، أو محاولة اكتشاف كل شيء بمفردك. أخيرًا التزمي مع مدربة ومجتمع من الأخوات يدعمنك في كل خطوة.",
    cta: "انضمي إلى البرنامج لمدة 6 أسابيع",
    starts: "معسكر StrongerHer الصيفي · يبدأ 21 يونيو 2026",
    badgeTop: "تدريب مباشر",
    badgeBottom: "للنساء فقط · خاص · مسجّل",
  },
  video: {
    eyebrow: "شاهدي وتعلّمي",
    h2: "شاهدي كيف يعمل معسكر StrongerHer الصيفي",
    p: "في هذا الفيديو القصير، تشرح المدربة هبة كيف يساعد البرنامج المرأة على فقدان الدهون، وبناء القوة، وفهم التغذية، والالتزام بدعم التدريب المباشر ومجتمع من النساء فقط.",
    soon: "فيديو المبيعات قريبًا",
    soonSub: "المدربة هبة تشرح البرنامج هنا",
  },
  stories: {
    eyebrow: "قصص نجاح",
    h2: "نساء حقيقيات. نتائج حقيقية.",
    p: "اطلعي على تجارب النساء من خلال تدريب المدربة هبة، والإرشاد الغذائي، والمساءلة، والمجتمع الداعم.",
  },
  results: {
    eyebrow: "النتائج",
